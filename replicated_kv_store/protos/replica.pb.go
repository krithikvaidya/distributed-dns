...
type AppendEntriesMessage struct {
	...
	Entries      []int32 `protobuf:"varint,5,rep,packed,name=entries,proto3" json:"entries,omitempty"`
}
...
func (x *AppendEntriesMessage) GetEntries() []int32 {
	if x != nil {
		return x.Entries
	}
	return nil
...
var file_replica_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x65, 0x64, 0x22, 0xaa, 0x01, 0x0a, 0x14, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x45,
	0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a,
	...
	0x65, 0x72, 0x6d, 0x12, 0x1c, 0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x05,
	0x20, 0x03, 0x28, 0x05, 0x42, 0x02, 0x10, 0x01, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65,
...
var file_replica_proto_goTypes = []interface{}{
	...
	(*AppendEntriesMessage)(nil),  // 2: protos.AppendEntriesMessage
	(*AppendEntriesResponse)(nil), // 3: protos.AppendEntriesResponse
	(*empty.Empty)(nil),           // 4: google.protobuf.Empty
}
var file_replica_proto_depIdxs = []int32{
	4, // 0: protos.ConsensusService.ReplicaReady:input_type -> google.protobuf.Empty
	0, // 1: protos.ConsensusService.RequestVote:input_type -> protos.RequestVoteMessage
	2, // 2: protos.ConsensusService.AppendEntries:input_type -> protos.AppendEntriesMessage
	4, // 3: protos.ConsensusService.ReplicaReady:output_type -> google.protobuf.Empty
	1, // 4: protos.ConsensusService.RequestVote:output_type -> protos.RequestVoteResponse
	3, // 5: protos.ConsensusService.AppendEntries:output_type -> protos.AppendEntriesResponse
